// FixedPointTest.cpp -- fixed point number tests
//
// Part of the bijou Project, under the Apache License v2.0 with LLVM Exceptions.
//
// This file is a modified copy of the file "unittests/ADT/FixedPointTest.cpp" from the LLVM Project.
...
using bijou::APFixedPoint;
using bijou::APFloat;
using bijou::APInt;
using bijou::APSInt;
using bijou::FixedPointSemantics;
